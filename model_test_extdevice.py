...
datadir_name = "MarsDatasetv3" #"SMo","RMo","AI4Mars","MarsDatasetv3"
...
def test_network():
    ...
    for img_name in list_temp:
        ...
        if (img_name.startswith("Mars")): 
            ...
            if (datadir_name != "MarsDatasetv3"): continue
        ...
        # FLOPS counting and evaluations
